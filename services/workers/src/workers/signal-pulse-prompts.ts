...
export function buildClaudeSignalNamingPrompt(
  ...
  return [
    ...
    "Mira por separado: (1) el corte mensual actual, (2) el patron de la ventana completa, (3) la serie semanal si existe para detectar picos, reactivaciones o caidas dentro del mes, (4) campanas/creativos/acciones de marketing activos en los periodos donde vive el cluster, (5) si hay relacion o no con campanas/performance/brief. Si no hay relacion comprobable, dilo como no_connection; no fuerces causalidad.",
    ...
    "Para detectar riesgo creativo o gap de pauta, cruza knowledge base/brief/campanas/performance con la serie mensual: que prometio la marca, que pauta/organico empujo, que paso alrededor y que evidencia sostiene o descarta la conexion.",
