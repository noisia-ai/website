...
export function buildClaudeSignalNamingPrompt(
  ...
  return [
    ...
    "Empieza cada lectura por investigation_brief: current_cut, window_pattern, strongest_periods, weekly_pulses, marketing_intersections, evidence_map y synthesis_questions. Ese brief organiza el caso; úsalo para decidir si la señal es de corte actual, patrón de ventana o mixta.",
    ...
    "Para actionability=\"publish\", title debe tener taxonomia + tesis accionable, signal_role debe corresponder a esa taxonomia, evidence_basis debe citar mention_id reales, action_hint debe decir una accion de marketing medible y performance_connection debe estar calificada.",
