...
const MAX_CLAUDE_SAMPLES_PER_CLUSTER = 12;
...
export async function signalPulseReadinessJob(job: Job<SignalPulseStepJobData>) {
  return runSignalPulseStep(job, async ({ engineAnalysisId, pipelineStepId }) => {
    ...
    const readiness = {
      ...
      marketing_brief_categories: knowledgeContext.marketingBriefCategories,
      minimum_marketing_brief_signals: knowledgeContext.minimumBriefSignals,
      minimum_marketing_brief_categories: knowledgeContext.minimumBriefCategories,
