...
(() => {
  ...
  class DeckStage extends HTMLElement {
    ...
    // View-only decks (client-facing) keep click/keyboard navigation on the
    // thumbnail rail but suppress editing affordances: drag-reorder, the
    // right-click context menu (skip / move / delete) and its confirm dialog.
    ...
    _makeThumb(slide) {
      ...
      if (this.readonly) {
        // Read-only: navigation only. Skip all drag-reorder wiring.
