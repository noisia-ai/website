# Sources screen specification

## Propósito

Contiene Source Wizard, connected sources, mappings, sync health, source quality y roles de fuente.

## Preguntas de usuario

- ¿Qué fuentes están conectadas?
- ¿Qué alimenta cada una?
- ¿Qué fuente está rota o atrasada?
- ¿Qué mapping tiene?
- ¿Qué charts activa?
...
- Valid/invalid records chart
- Source freshness heatmap
- Record count by source type
- Mapping completeness progress
...
- Pause source
- View sync logs
- Activate for Signal Pulse

## Conexión al corpus vivo

Sources consume source_connections, datasets, mappings, sync runs, validation reports, source health and data type classification.
