# Content & Creative screen specification

## Propósito

Baja señales a hooks, formatos, claims, tonos, creators y mini-briefs. Debe servir para social, content, creative y agencias.
...
- ¿Qué asset orgánico puede convertirse en pauta?
...
- Hook library
- Claim testing candidates
- Format recommendations
- Tone do/dont cards
- Creator angle cards
- Mini-brief builder
- Organic asset opportunities
- Creative no-go list

## Charts sugeridos

- Hook opportunity matrix
- Format performance by signal
- Claim saturation map
- Organic posts by signal fit
- Creator/community map
...
- Click hook abre examples
- Generate mini-brief draft
- Attach evidence
- Compare hooks
- Open paid/organic link

## Conexión al corpus vivo

Content & Creative consume conversation evidence, organic performance, creative text, campaign/entity refs, signal interpretations y marketing moves.
