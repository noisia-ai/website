# Marketing Moves screen specification

## Propósito

Convierte señales en decisiones accionables para Marketing. Es la pantalla más importante para pasar de insight a acción.

## Preguntas de usuario

- ¿Qué puede hacer Marketing con estas señales?
- ¿Qué test de claim conviene lanzar?
- ¿Qué narrativa amplificar o evitar?
- ¿Qué mover en pauta o contenido?
- ¿Qué acción tiene más evidencia?
...
- Drag status interno
- Click move abre evidence
- Send to brief draft
- Mark as approved
- Attach to monthly cut

## Conexión al corpus vivo

Marketing Moves consume signal_cards, marketing_move candidates, evidence refs, confidence, performance overlays y composer edits.
