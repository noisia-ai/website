# Paid / Organic screen specification

## Propósito

Cruza conversación con performance de contenido y pauta para detectar gaps, oportunidades y desalineaciones presupuestales.

## Preguntas de usuario

- ¿Nuestra pauta sigue la conversación real?
- ¿Qué orgánico merece inversión?
- ¿Dónde gastamos en narrativa sin señal?
- ¿Qué señal tiene conversación alta e inversión baja?
- ¿Qué creative territory performa mejor?
...
- Conversation vs spend overview
- Paid/organic gap cards
- Campaign alignment table
- Organic-to-paid candidates
- Spend by narrative
- Creative territory diagnostics
- Budget defense notes

## Charts sugeridos

- Conversation vs spend dual-axis
- Gap matrix
- Spend by narrative stacked bar
- Organic engagement by signal
- Creative fit scatter
- Performance trend by territory
...
- Click campaign abre evidence/performance
- Click gap genera move
- Toggle metric CTR/CPM/conversion
- Export budget defense summary

## Conexión al corpus vivo

Paid / Organic consume performance evidence, campaign entities, creative text, signal mapping, monthly period metrics and source freshness.
