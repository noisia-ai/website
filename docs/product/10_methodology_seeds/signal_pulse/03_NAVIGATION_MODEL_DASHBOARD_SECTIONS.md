# 03 — Navigation model: dashboard screens vs components

## Definición

En Signal Pulse, una pantalla es una sección navegable del dashboard. Aparece como item en sidebar o navegación lateral. Un componente es un bloque dentro de una pantalla. Un drawer es una profundización contextual sin cambiar de pantalla.
...
Contiene lo que el cliente necesita para entender la lectura principal y las decisiones inmediatas.

### MARKETING INTELLIGENCE

Contiene las capas que traducen señales a áreas de Marketing: creatividad, pauta, orgánico, competencia y categoría.

### EVIDENCE & CORPUS

Contiene prueba, exploración y conexión a data viva.

### PUBLISHING

Contiene edición, publicación, confidence y control de calidad.
...
## Cómo se mapea cada idea a pantalla

| Idea / capability | Pantalla |
|---|---|
| Executive Signal Read | Overview |
| Semantic Signal Galaxy | Overview, con drill-down a Signals/Evidence |
| Emotional Density Map | Overview, con filtros globales |
| Impact × Polarity Map | Overview y Signals |
...
|---|---|
| Ready | Item normal |
| Needs source | Item con badge `Needs data` |
| Internal only | Item visible solo a Noisia |
| Draft only | Item visible en working draft, no cliente |
| Published | Item visible al cliente |
| Warning | Badge de quality warning |
| Failed | Item con error y camino de resolución |
